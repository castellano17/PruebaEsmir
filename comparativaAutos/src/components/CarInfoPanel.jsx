import carBackDesktop from "../assets/images/car2-back-desktop.jpg";
import carBackDesktopAlt from "../assets/images/car1-back.jpg";
import carFront from "../assets/images/car1.png";
import carFrontAlt from "../assets/images/car2.png";
import carLogo from "../assets/images/car1-logo.png";
import carLogoAlt from "../assets/images/car2-logo.png";
import carBackMobile from "../assets/images/car2-back-mobile.jpg";
import carBackMobileAlt from "../assets/images/car1-back-mobile.jpg";
import carMobile from "../assets/images/car2-mobile.png";
import carMobileAlt from "../assets/images/car1-mobile.png";
  ...
  return (
    <>
      <section className="absolute w-screen min-h-screen overflow-hidden">
        <div className="text-white absolute w-screen min-h-screen ">
          <img
          ...
          />
          <div className="absolute top-[15%] left-1/2 transform -translate-x-1/2 text-center text-base flex flex-row justify-around items-center w-[90%]">
